...
<div class="contain">
    ...
    <table class="dataintable">
        ...
        <tr>
            <td><a href="#" title="CSS .class 选择器">.<i>class</i></a></td>
            <td>.intro</td>
        ...
        <tr>
            <td><a href="#" title="CSS #id 选择器">#<i>id</i></a></td>
            <td>#firstname</td>
        ...
        <tr>
            <td><a href="#" title="CSS element 选择器"><i>element</i></a></td>
            <td>p</td>
            <td>选择所有 &lt;p&gt; 元素。</td>
            <td>1</td>
        </tr>
        ...
        <tr>
            <td><a href="#" title="CSS :nth-last-of-type(n) 选择器">:nth-last-of-type(<i>n</i>)</a></td>
        ...
        <tr>
            <td><a href="#" title="CSS :last-child 选择器">:last-child</a></td>
            <td>p:last-child</td>
        ...
        <tr>
            <td><a href="#" title="CSS :root 选择器">:root</a></td>
            <td>:root</td>
            <td>选择文档的根元素。</td>
            <td>3</td>
        </tr>
        ...
        <tr>
            <td><a href="#" title="CSS :empty 选择器">:empty</a></td>
            <td>p:empty</td>
        ...
        <tr>
            <td><a href="#" title="CSS :target 选择器">:target</a></td>
            <td>#news:target</td>
        ...
        <tr>
            <td><a href="#" title="CSS :enabled 选择器">:enabled</a></td>
            <td>input:enabled</td>
        ...
        <tr>
            <td><a href="#" title="CSS :disabled 选择器">:disabled</a></td>
        ...
        <tr>
            <td><a href="#" title="CSS :checked 选择器">:checked</a></td>
            <td>input:checked</td>
        ...
        <tr>
            <td><a href="#" title="CSS :not(selector) 选择器">:not(<i>selector</i>)</a></td>
            <td>:not(p)</td>
            <td>选择非 &lt;p&gt; 元素的每个元素。</td>
            <td>3</td>
        </tr>
        ...
        <tr>
            <td><a href="#" title="CSS ::selection 选择器">::selection</a></td>
            <td>::selection</td>
            <td>选择被用户选取的元素部分。</td>
            <td>3</td>
        </tr>
